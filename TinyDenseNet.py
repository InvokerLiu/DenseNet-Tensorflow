...
#
#   Editor      : PyCharm
#   File name   : TinyDenseNet.py
#   Author      : LiuBo
#   Created date: 2019-04-28 16:55
#   Description :
#
# ================================================================
...
class TinyDenseNet(object):
    def __init__(self, dense_block_num=3, growth_rate=12, filter_num=32, reduction=0.0,
                 class_num=10, input_size=40, channels=3, training=True, name="dense_net",
