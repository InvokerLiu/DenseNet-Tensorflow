...
#
#   Editor      : PyCharm
#   File name   : DenseNet24.py
#   Author      : LiuBo
#   Created date: 2019-05-08 17:06
#   Description :
#
# ================================================================
...
class DenseNet24(object):
    def __init__(self, dense_block_num=2, growth_rate=12, filter_num=32, reduction=0.0,
                 class_num=6, input_size=24, channels=3, training=True, name="dense_net24",
