...
#
#   Editor      : PyCharm
#   File name   : DenseNet48.py
#   Author      : LiuBo
#   Created date: 2019-05-08 19:33
#   Description :
#
# ================================================================
...
class DenseNet48(object):
    def __init__(self, dense_block_num=3, growth_rate=12, filter_num=32, reduction=0.0,
                 class_num=6, input_size=48, channels=3, training=True, name="dense_net48",
