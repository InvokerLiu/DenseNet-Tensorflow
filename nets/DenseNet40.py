...
#
#   Editor      : PyCharm
#   File name   : DenseNet40.py
#   Author      : LiuBo
#   Created date: 2019-05-08 17:00
#   Description :
#
# ================================================================
...
class DenseNet40(object):
    def __init__(self, dense_block_num=3, growth_rate=12, filter_num=32, reduction=0.0,
                 class_num=6, input_size=40, channels=3, training=True, name="dense_net40",
